...
\bottomrule
\end{tabular}}
\caption{Mean (and std) non-parametric probing accuracy on different datasets - Linzen et al. (LZ) \cite{linzen-etal-2016-assessing}, Gulordava et al. (GL) \cite{gulordava2018} and Marvin et al (MA) \cite{marvin-linzen-2018-targeted}}
\label{tab:non_param_comb}
\vspace{-20pt}
\end{wraptable}
